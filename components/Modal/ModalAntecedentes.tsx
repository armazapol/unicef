    ...
    >
      ...
      <div className="w-10/12 md:w-[40rem] bg-white flex flex-col gap-2 p-5 relative component rounded-md h-5/6 lg:h-auto overflow-x-hidden overflow-y-auto text-sm lg:text-base">
        ...
        <p>
          ...
          nacional, con medidas de prevención y control del{" "}
          <span className="text-orange-600">COVID-19</span>, el 11 de marzo del
          2020, mediante Decreto supremo N°008-2020-SA.
          <a
        ...
        <p>
          ...
          217,519 fallecidos, según la sala situacional del Ministerio de Salud{" "}
          <a
            className="underline hover:text-blue-500"
