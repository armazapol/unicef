...
import img1 from "../../public/img/view3/hepatitis/img1.jpg";
import img2 from "../../public/img/view3/hepatitis/img2.jpg";
        ...
        >
            ...
            <div className="w-10/12 lg:w-[55rem] h-[14rem] sm:h-[15rem] lg:h-auto bg-white flex gap-2 p-5 lg:p-10 relative component rounded-md overflow-auto">
              <div className="flex-1 overflow-y-auto">
                ...
                <div className="text-left flex flex-col gap-2">
                  ...
                  <p>
                    Esta es una enfermedad del hígado causada por el virus de la
                    hepatitis A. Los niños con este virus por lo general no
                    tienen síntomas, pero a menudo contagian la enfermedad a
                    otras personas, incluidos sus padres o las personas que los
                    cuidan que no se hayan vacunado. Estas personas se pueden
                    enfermar gravemente.
                  </p>
                  <p>
              ...
              <div className="relative flex-1">
                ...
                />
                <a
                  onClick={() => window.open("/img/view3/hepatitis/img1.jpg")}
          ...
          <div className=" flex items-center justify-center  relative flex-col h-full gap-5">
            <div className="w-10/12 lg:w-[40rem] h-[14rem] sm:h-[15rem] lg:h-auto bg-white flex flex-col gap-2 p-5 lg:p-10 relative component rounded-md overflow-auto text-sm lg:text-base">
              <div className="text-left flex flex-col gap-2">
                <p className="">
                  Los niños menores de 6 años por lo general no tienen ningún
                  síntoma. Los niños mayores y los adultos se sienten muy mal y
                  débiles. Los síntomas aparecen, por lo general, entre 2 a 6
                  semanas después de que una persona contraiga el virus. Estos
                  síntomas pueden ser:
                </p>
                <ul>
                  <li>* Fiebre</li>
                ...
                <p>
                  El virus de la hepatitis A se encuentra en las heces de las
                  personas que lo tienen. Se propaga cuando alguien se lleva a
                  la boca algo que contiene el virus de la hepatitis A. Aunque
                  se vea limpio, este artículo aún puede contener virus que
                  podrían propagarse a otras personas. La cantidad de heces
                  puede ser tan pequeña que no se distingue a simple vista. Se
                  puede contraer la hepatitis A mediante la ingesta de alimentos
                  o agua que tengan el virus.
                </p>
              </div>
            </div>
          </div>
          <div className=" flex items-center justify-center  relative flex-col h-full gap-5">
            <div className="w-10/12 lg:w-[55rem] h-[14rem] sm:h-[15rem] lg:h-auto bg-white flex gap-2 p-5 lg:p-10 relative component rounded-md overflow-auto">
              ...
              <div className="text-left flex flex-col gap-2">
                <p>
                  La complicación más temida es la hepatitis fulminante,
                  caracterizada por una rápida progresión a insuficiencia
                  hepática asociando encefalopatía. Si bien solo el 1% -2% de
                  todos los casos de hepatitis virales agudas se complican con
                  hepatitis fulminante, el 75% de los casos de hepatitis
                  fulminante son causados por hepatitis virales.
                </p>
                <p>
                  El esquema contempla una sola dosis a los 15 meses de edad.
                  Las probables reacciones luego de la administración son leves
                  e incluyen dolor local y, con menor frecuencia, induración en
                  el sitio de la inyección, pérdida de apetito, somnolencia,
                  cefalea o febrícula.
                </p>
                <p className="underline hover:text-blue-500  text-sm">
                  <span className="font-semibold"> Fuente: </span>
                  <a
                    href="https://www.cdc.gov/vaccines/parents/diseases/hepa-sp.html"
                    target="blank"
                  >
                    Vacunas infantiles contra la hepatitis A | CDC, Hepatitis A
                    (scielo.sa.cr), Norma Técnica de Salud - NTS N°
                    196-MINSA/DGIESP-2022zyxwvutsrqponmlkjihgfedcbaZYXWVUTS I.
                    II. - Studocu
                  </a>
                </p>
              </div>
              ...
              <div className="relative flex-1">
                ...
                />
                <a
                  onClick={() => window.open("/img/view3/hepatitis/img2.jpg")}
                  className="absolute left-5 bottom-5 z-20 cursor-pointer"
                >
                  <img
                    className="w_loop hidden lg:block"
