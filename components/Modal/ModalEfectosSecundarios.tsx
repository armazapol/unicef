            ...
            <div className="w-10/12 lg:w-[40rem] h-[18rem] sm:h-[22rem] lg:h-auto bg-white flex flex-col gap-2 p-5 relative component rounded-md overflow-auto">
              ...
              <div className="text-sm lg:text-base text-left flex flex-col gap-2">
                <p>
                  ...
                  protegen. Tras vacunarse, algunas personas presentan síntomas
                  de leves a moderados que se deben a que su sistema inmunitario
                  está haciendo que su organismo reaccione de una determinada
                  manera, por ejemplo, aumentando la circulación de la sangre
                  para que se distribuyan más células inmunitarias y aumentando
                  la temperatura corporal para matar más fácilmente a los virus.
                </p>
                <p>
                  ...
                  molécula que desencadena la respuesta inmunitaria) y de que se
                  está preparando para luchar contra el virus. Por lo general,
                  los efectos secundarios desaparecen espontáneamente a los
                  pocos días.{" "}
                </p>
                <p>
                  ...
                  no significa que la vacuna no sea eficaz, porque cada persona
                  reacciona de forma distinta a las vacunas.
                </p>
              </div>
            </div>
          </div>
